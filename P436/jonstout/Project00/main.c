...
int main()
{
  ...
  for (c = 0; c < stringCount; c++)
  {
    ...
    // Make param e = the length of the previous string
    // this way we know where the world part of the
    // string should go. " - 1 " to get rid of the extra space.
...
void ypoc(char* into, char* from)
{
  ...
  // Add string delim to end of flipped string
  into[len] = 0;
}
